...
SLAM Toolbox 2D SLAM benchmark suite
    ...
    Generates latexpdf report from tum_report template in cartographer_ros_benchmarks ROS package
...
SLAM Toolbox 2D SLAM benchmark case
    ...
    Uses tum_benchmark.launch in cartographer_ros_benchmarks ROS package as rig

...
Cartographer ROS SLAM benchmark suite
    ...
    Generates latexpdf report from mars_report template in cartographer_ros_benchmarks ROS package
...
Cartographer ROS 2D SLAM benchmark case
    ...
    Uses mars_benchmark.launch in cartographer_ros_benchmarks ROS package as rig

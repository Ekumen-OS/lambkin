...
*** Settings ***
Documentation   Cartographer ROS 2D SLAM benchmark using Rawseeds datasets
...
Cartographer ROS 2D SLAM benchmark suite
    ...
    Generates latexpdf report from rawseeds_report template in cartographer_ros_benchmarks ROS package
...
Cartographer ROS 2D SLAM benchmark case
    ...
    Uses rawseeds_benchmark.launch in cartographer_ros_benchmarks ROS package as rig

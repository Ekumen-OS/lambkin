RTABMAP benchmarks with TUM dataset
================================================
...
RTABMAP performance was put to test as follows. Selected parameters
...
.. list-table:: Metric statistics
   ...
   * - .. plot::
         ...
         data = lambkin.data.pandas.inner_join([
             ...
             lambkin.data.timem.summary('rtabmap_node')
         ], on=['case.name', 'iteration.index'])

         data = lambkin.data.pandas.rescale(data, {
             'rtabmap_node.summary.cpu_util': 100,
             'rtabmap_node.summary.peak_rss': 1 / 8e6
         })
         ...
         data = data.melt(
             ...
             value_vars=[
                 ...
                 'rtabmap_node.summary.cpu_util',
                 'rtabmap_node.summary.peak_rss'
             ],
         )
         ...
         data = data.replace({'name': {
             ...
             'rtabmap_node.summary.cpu_util': 'CPU usage (%)',
             'rtabmap_node.summary.peak_rss': 'Peak RSS (MB)'
         }})
...
.. list-table:: Time series and histograms
   ...
   * - .. plot::
         ...
         sns.lineplot(
             lambkin.data.pandas.rescale(
                 lambkin.data.timem.history('rtabmap_node'), {
                     'rtabmap_node.series.virtual_memory': 1 / 8e6
                 }
             ),
             x='rtabmap_node.series.time',
             y='rtabmap_node.series.virtual_memory',
     ...
     - .. plot::
         ...
         sns.histplot(
             ...
             x='rtabmap_node.summary.cpu_util',
   ...
   * - .. plot::
         ...
         sns.lineplot(
             lambkin.data.pandas.rescale(
                 lambkin.data.timem.history('rtabmap_node'), {
                     'rtabmap_node.series.page_rss': 1 / 8e6
                 }
             ),
             x='rtabmap_node.series.time',
             y='rtabmap_node.series.page_rss',
             hue='case.name', n_boot=20
         )
     ...
     - .. plot::
         ...
         sns.histplot(
             ...
             x='rtabmap_node.summary.peak_rss',
             hue='case.name', element='step', kde=True
         )

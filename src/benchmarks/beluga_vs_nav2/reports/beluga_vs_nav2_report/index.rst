...
Compare `Beluga AMCL <https://github.com/Ekumen-OS/beluga>`_ and `Nav2 AMCL <https://github.com/ros-planning/navigation2/tree/main/nav2_amcl>`_ localization systems in terms of localization and computational performance.
...
.. repl-quiet::
    ...
    nominal_case = list(lks.access.iterations([
        ...
        location.metadata['variation']['parameters']['laser_model'] == 'likelihood_field' and
...
.. repl-quiet::
    ...
    data['trajectory.qualified_name'] = data.apply(
        lambda row: '{} ({}, {})'.format(
            row['trajectory.name'],
            row['variation.parameters.laser_model'],

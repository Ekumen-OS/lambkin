...
.. list-table:: Metric mean value comparison

   * - .. plot::

         data = pd.read_csv('stats.data')
         g = sns.catplot(data=data, x='mean', y='test', col='metric', col_wrap=2,
            kind='bar', sharex=False, alpha=.5)
...
.. list-table:: Time series and histograms
   ...
   * - .. plot::
         ...
         data = pd.read_csv('timeseries_ape.data')
   ...
   * - .. plot::
         ...
         data = pd.read_csv('timeseries_rpe.data')

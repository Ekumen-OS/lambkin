...
SLAM Toolbox 2D SLAM benchmark suite
    ...
    Generates latexpdf report from rawseeds_report template in slam_toolbox_benchmarks ROS package
...
SLAM Toolbox 2D SLAM benchmark case
    ...
    Uses rawseeds_benchmark.launch in slam_toolbox_benchmarks ROS package as rig

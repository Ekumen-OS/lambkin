...
SLAM Toolbox 2D SLAM benchmark suite
    ...
    Generates latexpdf report from parametric_tum_report template in slam_toolbox_benchmarks ROS package
...
SLAM Toolbox 2D SLAM benchmark case
    ...
    Uses parametric_tum_benchmark.launch in slam_toolbox_benchmarks ROS package as rig

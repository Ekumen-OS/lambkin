...
Cartographer ROS performance was put to test as follows. Selected parameters
include: the datasets that were used, the input sensor topics, the trajectories
to compare, and the amount of iterations.
...
.. list-table:: Time series and histograms
   ...
   * - .. plot::
         ...
         sns.lineplot(
             lambkin.data.evo.series('/tf:map.base_link', 'ape'),
   ...
   * - .. plot::
         ...
         sns.lineplot(
             lambkin.data.evo.series('/tf:map.base_link', 'rpe'),
